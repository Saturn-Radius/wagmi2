...
const ConnectWalletPage = styled.div`
    ...
    <ConnectWalletPage>
      <SectionCon>
        ...
        <Section1>
          <SectionTitle/>
          <SectionTitle1>
            <Title color="#ffffff" size="17px">Please connect your wallet</Title>
          </SectionTitle1>
          <Section>
            <ConButton name="metaMask">
              METAMASK
              <img src="/benqi/MetaMask.svg" alt="MetaMask" />
            </ConButton>
            <ConButton name="metaMask">
              COINBASE WALLET
              <img src="/benqi/coinbase-wallet.png" alt="MetaMask" />
            </ConButton>
            <ConButton name="metaMask">
              COIN98
              <img src="/benqi/coin98.png" alt="MetaMask" />
            </ConButton>
            <ConButton name="metaMask">
              WALLETCONNECT
              <img src="/benqi/Walletconnect.svg" alt="MetaMask" />
            </ConButton>
          </Section>
        </Section1>
        <SectionImgMark/>
